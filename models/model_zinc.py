...
class MoleculeVAE():
    ...
    def _buildEncoder(self, x, latent_rep_size, max_length, epsilon_std = 0.01):
        ...
        def sampling(args):
            ...
            # epsilon = K.random_normal(shape=(batch_size, latent_rep_size), mean=0., std = epsilon_std)  # upgrade fro new keras
        ...
        def conditional(x_true, x_pred):
            ...
            # P2 = tf.mul(K.exp(x_pred),M3) # apply them to the exp-predictions  # <- upgrade for new tf >= 1.2
